...
class BfdV204CommandNomenclatureSerializationTest {
    @Test
    fun shouldSerializeCommandNomenclatureWithCurrentVersionOnlyOnBfd204() {
        val json = buildRequestJson(currentVersion = 0, barcode = null, reqNum = 1)
        assertSerialized(json)
    }

    @Test
    fun shouldSerializeCommandNomenclatureWithBarcodeOnBfd204() {
        val json = buildRequestJson(currentVersion = 1, barcode = "0200091530572", reqNum = 2)
        assertSerialized(json)
    }
