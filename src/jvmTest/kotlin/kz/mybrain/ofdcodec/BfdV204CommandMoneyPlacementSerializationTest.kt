...
class BfdV204CommandMoneyPlacementSerializationTest {
    @Test
    fun shouldSerializeCommandMoneyPlacementDepositOnBfd204() {
    ...
    @Test
    fun shouldSerializeCommandMoneyPlacementWithdrawalOnBfd204() {
        val json = buildRequestJson(
