...
/**
 * Чтение TaxTypeEnum из JSON.
 */
class TaxTypeBuilder {
    /**
     * Читает TaxTypeEnum по ключу и возвращает его значение.
     */
    fun readRequired(json: JsonObject, key: String): Nomenclature.NomenclatureResponse.TaxTypeEnum {
        val value = readString(json, key)
        return Nomenclature.NomenclatureResponse.TaxTypeEnum.valueOf(value ?: throw IllegalArgumentException("Missing $key"))
    }
