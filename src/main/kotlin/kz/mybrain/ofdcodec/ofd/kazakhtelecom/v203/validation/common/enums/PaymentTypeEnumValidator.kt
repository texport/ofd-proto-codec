...
/**
 * Валидация PaymentTypeEnum для протокола Казахтелеком v203.
 */
class PaymentTypeEnumValidator {
    /**
    ...
    companion object {
        private val ALLOWED = Common.PaymentTypeEnum.entries.map { it.name }.toSet()
    }
}
