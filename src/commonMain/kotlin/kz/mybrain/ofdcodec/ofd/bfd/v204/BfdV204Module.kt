...
import kz.mybrain.ofdcodec.ofd.bfd.v204.codec.command.CommandCloseShiftRequestBuilder
import kz.mybrain.ofdcodec.ofd.bfd.v204.codec.command.CommandInfoRequestBuilder
import kz.mybrain.ofdcodec.ofd.bfd.v204.codec.command.CommandMoneyPlacementRequestBuilder
import kz.mybrain.ofdcodec.ofd.bfd.v204.codec.command.CommandNomenclatureRequestBuilder
import kz.mybrain.ofdcodec.ofd.bfd.v204.codec.command.CommandReportRequestBuilder
import kz.mybrain.ofdcodec.ofd.bfd.v204.codec.command.CommandSystemRequestBuilder
import kz.mybrain.ofdcodec.ofd.bfd.v204.codec.command.CommandTicketRequestBuilder
 ...
 */
object BfdV204Module {
    const val OFD_ID = "bfd"
    const val PROTOCOL_VERSION = "204"
    ...
    internal fun defaultHandler(ofdId: String = OFD_ID): OfdProtocolHandler {
        ...
        val requestSerializer = BfdV204RequestSerializer(
            mapOf(
        ...
        val responseDeserializer = BfdV204ResponseDeserializer()
