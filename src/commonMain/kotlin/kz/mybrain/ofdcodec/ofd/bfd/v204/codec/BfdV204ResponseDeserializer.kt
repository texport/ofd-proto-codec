package kz.mybrain.ofdcodec.ofd.bfd.v204.codec
 ...
 */
internal class BfdV204ResponseDeserializer : Deserializer {
    /**
    ...
    private fun buildOrgRegInfo(org: OrgRegInfo): JsonObject {
        return buildJsonObject {
            ...
            put("inn", JsonPrimitive(org.iin))
            put("okved", JsonPrimitive(org.oked))
        }
    }
    ...
    private fun buildReportResponse(report: ReportResponse): JsonObject {
        return BfdV204ReportDeserializerHelper.buildReportResponse(report)
    }
