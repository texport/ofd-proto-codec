...
class CommandCloseShiftNetworkClientTest {
    @Test
    fun shouldSendCommandCloseShiftOverTcp() = runBlocking {
        ...
        val json = buildRequestJson(token)
        println(
    ...
    private fun buildRequestJson(token: Long): kotlinx.serialization.json.JsonElement {
