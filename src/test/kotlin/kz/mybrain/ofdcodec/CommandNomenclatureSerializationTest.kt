...
class CommandNomenclatureSerializationTest {
    @Test
    fun shouldSerializeCommandNomenclatureWithCurrentVersionOnly() {
        val json = buildRequestJson(currentVersion = 0, barcode = null, reqNum = 1)
        assertSerialized(json)
    }

    @Test
    fun shouldSerializeCommandNomenclatureWithBarcode() {
