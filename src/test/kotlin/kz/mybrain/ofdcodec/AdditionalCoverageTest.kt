...
class AdditionalCoverageTest {
    ...
    fun testHeaderCodecInvalidVersionsAndSizes() {
        ...
        val errors = (decodeResult as HeaderDecodeResult.Errors).errors
    ...
    fun testReportDeserializationAndHelpers() {
        ...
        val reportResponse = Report.ReportResponse.newBuilder()
            .setReport(Report.ReportTypeEnum.REPORT_Z)
            .setZxReport(zxReport)
            .build()

        val message = Message.Response.newBuilder()
            .setCommand(Message.CommandTypeEnum.COMMAND_REPORT)
            .setResult(Message.Result.newBuilder().setResultCode(0).setResultText("Success"))
    ...
    fun testNomenclatureDeserialization() {
        val element = Nomenclature.NomenclatureResponse.Element.newBuilder()
            .setType(Nomenclature.NomenclatureResponse.ElementTypeEnum.ITEM)
            .setTitle("Title")
            .setTitleKk("TitleKk")
        ...
        val message = Message.Response.newBuilder()
            ...
            .setResult(Message.Result.newBuilder().setResultCode(0))
            .setNomenclature(nomenclatureResponse)
            .build()
    ...
    private fun createFullZXReport(): Report.ZXReport {
        val date = Common.Date.newBuilder().setYear(2024).setMonth(9).setDay(1).build()
        val time = Common.Time.newBuilder().setHour(12).setMinute(5).setSecond(30).build()
        val dateTime = Common.DateTime.newBuilder().setDate(date).setTime(time).build()
        val money = Common.Money.newBuilder().setBills(100L).setCoins(50).build()
        ...
        val operation = Report.ZXReport.Operation.newBuilder()
            .setOperation(Common.OperationTypeEnum.OPERATION_SELL)
            .setCount(10)
            .setSum(money)
            .build()

        val taxOp = Report.ZXReport.Tax.TaxOperation.newBuilder()
            .setOperation(Common.OperationTypeEnum.OPERATION_SELL)
            .setTurnover(money)
            .setSum(money)
            .setTurnoverWithoutTax(money)
            .build()

        val tax = Report.ZXReport.Tax.newBuilder()
            .setTaxType(1)
            .setPercent(1200)
            .addOperations(taxOp)
            .build()

        val nonNullableSum = Report.ZXReport.NonNullableSum.newBuilder()
            .setOperation(Common.OperationTypeEnum.OPERATION_SELL)
            .setSum(money)
            .build()

        val zxPayment = Report.ZXReport.TicketOperation.Payment.newBuilder()
            .setPayment(Common.PaymentTypeEnum.PAYMENT_CARD)
            .setSum(money)
            .setCount(2)
            .build()

        val ticketOp = Report.ZXReport.TicketOperation.newBuilder()
            .setOperation(Common.OperationTypeEnum.OPERATION_SELL)
            .setTicketsTotalCount(10)
            .setTicketsCount(8)
            .setTicketsSum(money)
            .addPayments(zxPayment)
            .setOfflineCount(1)
            .setDiscountSum(money)
            .setMarkupSum(money)
            .setChangeSum(money)
            .build()

        val moneyPlacement = Report.ZXReport.MoneyPlacement.newBuilder()
            .setOperation(Report.MoneyPlacementEnum.MONEY_PLACEMENT_DEPOSIT)
            .setOperationsTotalCount(3)
            .setOperationsCount(3)
            .setOperationsSum(money)
            .setOfflineCount(0)
            .build()

        val annulledTickets = Report.ZXReport.AnnulledTickets.newBuilder()
            .setAnnulledTicketsTotalCount(2)
            .setAnnulledTicketsCount(2)
            .addAnnulledOperations(operation)
            .build()

        val revenue = Report.ZXReport.Revenue.newBuilder()
            .setSum(money)
            .setIsNegative(false)
            .build()

        return Report.ZXReport.newBuilder()
            .setDateTime(dateTime)
            .setShiftNumber(42)
            .addSections(section)
            .addOperations(operation)
            .addDiscounts(operation)
            .addMarkups(operation)
            .addTotalResult(operation)
            .addTaxes(tax)
            .addStartShiftNonNullableSums(nonNullableSum)
            .addTicketOperations(ticketOp)
            .addMoneyPlacements(moneyPlacement)
            .setAnnulledTickets(annulledTickets)
            .setCashSum(money)
            .setRevenue(revenue)
            .addNonNullableSums(nonNullableSum)
            .setOpenShiftTime(dateTime)
            .setCloseShiftTime(dateTime)
            .setChecksum("12345")
            .build()
    }
    ...
    fun testTicketRequestBuilderExhaustive() {
        ...
        assertEquals(6, ticketProto.itemsCount)
    ...
    fun testZXReportBuilderAllOptionalLists() {
        ...
        assertEquals(1, proto.shiftNumber)
        assertEquals(1, proto.sectionsCount)
        assertEquals(1, proto.operationsCount)
        assertEquals(1, proto.discountsCount)
        assertEquals(1, proto.markupsCount)
        assertEquals(1, proto.totalResultCount)
        assertEquals(1, proto.taxesCount)
        assertEquals(1, proto.startShiftNonNullableSumsCount)
        assertEquals(1, proto.ticketOperationsCount)
        assertEquals(1, proto.moneyPlacementsCount)
        assertTrue(proto.hasAnnulledTickets())
        assertTrue(proto.hasCloseShiftTime())
    }
    ...
    fun testMoneyPlacementRequestBuilderExceptions() {
        ...
        assertEquals(5, proto.frShiftNumber)
        assertEquals(10L, proto.printedDocumentNumber)
    }
    ...
    fun testResponseDeserializerServiceAndTicket() {
        ...
        val kkm = Reginfo.KkmRegInfo.newBuilder()
            .setPointOfPaymentNumber("pop")
            .setTerminalNumber("term")
            .setFnsKkmId("fns")
            .setSerialNumber("serial")
            .setKkmId("kkmId")
            .build()

        val org = Reginfo.OrgRegInfo.newBuilder()
            .setTitle("org")
            .setAddress("addr")
            .setAddressKz("addrKz")
            .setInn("inn")
        ...
        val pos = Reginfo.PosRegInfo.newBuilder()
            .setTitle("pos")
            .setAddress("posAddr")
            .setAddressKz("posAddrKz")
            .setLatitude(123)
            .setLongitude(456)
            .build()
        ...
        val ticket = Ticket.TicketResponse.newBuilder()
            .setTicketNumber("777")
            .setQrCode(com.google.protobuf.ByteString.copyFrom(byteArrayOf(1, 2, 3)))
            .build()
